...
namespace apps.Configs
{
    public class EngineResult : ActionBase
    {
        ...
        {
            //Get Data Cart
            EngineRequest? dataCart = JsonConvert.DeserializeObject<EngineRequest>(
        ...
        public static async Task<EngineResponse> CalculatePromoSingle(EngineRule dataPromo, EngineRequest dataCart)
        {
